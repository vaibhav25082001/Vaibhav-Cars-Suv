...
var HeaderCellComp = ({ ctrl }) => {
  ...
  if (isAlive && !cssManager.current) {
    cssManager.current = new import_ag_grid_community7.CssClassManager(() => eGui.current);
  }
...
var CellComp = ({
  ...
  const cssManager = (0, import_react17.useRef)();
  if (!cssManager.current) {
    cssManager.current = new import_ag_grid_community15.CssClassManager(() => eGui.current);
  }
...
var RowComp = ({ rowCtrl, containerType }) => {
  ...
  const cssManager = (0, import_react18.useRef)();
  if (!cssManager.current) {
...
var GridBodyComp = () => {
  ...
  const [topInvisible, setTopInvisible] = (0, import_react20.useState)(true);
  const [bottomInvisible, setBottomInvisible] = (0, import_react20.useState)(true);
  ...
  if (!cssManager.current) {
    cssManager.current = new import_ag_grid_community18.CssClassManager(() => eRoot.current);
  }
  ...
  const topClasses = (0, import_react20.useMemo)(
  ...
  const bottomClasses = (0, import_react20.useMemo)(
  ...
  Object.keys(nextProps).forEach((propKey) => {
    if (excludeReactCompProps.has(propKey)) {
      if (deprecatedReactCompProps.has(propKey)) {
        (0, import_ag_grid_community22._warn)(274, { prop: propKey });
      }
      return;
    }
...
var DetailCellRenderer = (0, import_react23.forwardRef)((props, ref) => {
  ...
  const registerGridApi = (0, import_react23.useCallback)((api) => {
...
var AgGridReact = class extends import_react24.Component {
  ...
  render() {
    return /* @__PURE__ */ import_react24.default.createElement(AgGridReactUi, { ...this.props, passGridApi: this.setGridApi });
  }
};
